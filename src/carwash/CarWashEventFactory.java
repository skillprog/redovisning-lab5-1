 ...
 */
public class CarWashEventFactory implements SimEventFactory {
    CarWashState state;
    ...
    public CarWashEventFactory(){}

    public void getNextEvent(double time, int id, SimState state){
        this.time = time;
        this.state = (CarWashState) state;
        this.state.setPreviousEventTime(time);
        this.id = id;
    }
